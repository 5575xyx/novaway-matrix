import type { Project, UserMessage } from "@novaway/sdk/v2"
...
import { previewSelectedLines } from "@novaway/ui/pierre/selection-bridge"
...
export default function Page() {
  ...
  const setFileTreeTab = (value: "changes" | "all" | "review") => layout.fileTree.setTab(value)
  ...
  const showAllFiles = () => {
    if (fileTreeTab() !== "changes" && fileTreeTab() !== "review") return
    setFileTreeTab("all")
  }
    ...
    void dialog.show(() => (
      <Dialog title={language.t("dialog.revert.title")}>
        <div class="p-4 min-w-[400px] max-w-[600px]">
          ...
          <div class="max-h-[300px] overflow-y-auto border rounded p-2 mb-4">
            <Show
              when={files.length > 0}
          ...
          <div class="flex justify-end gap-2">
            ...
            >
              {language.t("dialog.revert.confirm")}
            </Button>
          </div>
        </div>
      </Dialog>
