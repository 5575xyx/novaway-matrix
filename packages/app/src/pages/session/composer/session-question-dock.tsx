...
import { DockPrompt } from "@novaway/ui/dock-prompt"
import { Icon } from "@novaway/ui/icon"
import { showToast } from "@novaway/ui/toast"
import type { QuestionAnswer, QuestionRequest } from "@novaway/sdk/v2"
...
export const SessionQuestionDock: Component<{
  ...
  onSubmit: () => void
  onAnswered?: (answers: QuestionAnswer[]) => void
}> = (props) => {
  const sdk = useSDK()
