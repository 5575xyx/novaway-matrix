export const dict = {
  ...
  "dialog.provider.NovaWay.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.NovaWayGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NovaWay",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i NovaWay.",
  ...
  "provider.connect.NovaWayZen.line1":
    "NovaWay Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.NovaWayZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.NovaWayZen.visit.prefix": "Besøg ",
  "provider.connect.NovaWayZen.visit.link": "NovaWay.ai/zen",
  "provider.connect.NovaWayZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i NovaWay.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i NovaWay.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i NovaWay.json",
  ...
  "dialog.server.description": "Skift hvilken NovaWay-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af NovaWay ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NovaWay-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (NovaWay.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NovaWay understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NovaWay inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NovaWay-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NovaWay",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan NovaWay ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om NovaWay følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan NovaWay er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NovaWay starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NovaWay.",
