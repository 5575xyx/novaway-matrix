...
export const dict = {
  ...
  "dialog.provider.NovaWay.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.NovaWayGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaWay tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve NovaWay'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.NovaWayZen.line1":
    "NovaWay Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.NovaWayZen.visit.prefix": "",
  "provider.connect.NovaWayZen.visit.link": "NovaWay.ai/zen",
  "provider.connect.NovaWayZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve NovaWay'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak NovaWay'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler NovaWay.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi NovaWay sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "NovaWay'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı NovaWay ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (NovaWay.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: NovaWay henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "NovaWay ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "NovaWay Masaüstü",
  ...
  "settings.desktop.wsl.description": "NovaWay sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "NovaWay'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "NovaWay'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "NovaWay'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "NovaWay'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "NovaWay başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "NovaWay'un en son sürümünü kullanıyorsunuz.",
