...
export const dict = {
  ...
  "settings.permissions.row.autoApprove.title": "自动批准权限",
  "settings.permissions.row.autoApprove.description": "自动批准所有权限请求（危险！）",
  ...
  "settings.powersnexus.description": "查看第一方 PowersNexus 版本来源、更新策略与回滚状态。",
  "settings.powersnexus.active.title": "当前活动版本",
  "settings.powersnexus.active.description": "活动绑定始终使用创建绑定的 digest；更新失败不会破坏 active/bundled。",
  "settings.powersnexus.bundled.title": "内置基线",
  "settings.powersnexus.previous.title": "可回滚版本",
  "settings.powersnexus.installed.title": "已安装版本",
  "settings.powersnexus.installed.empty": "暂无额外已安装版本",
  "settings.powersnexus.field.policy": "更新策略",
  "settings.powersnexus.field.version": "版本",
  "settings.powersnexus.field.protocol": "协议版本",
  "settings.powersnexus.field.source": "来源",
  "settings.powersnexus.field.digest": "Digest",
  "settings.powersnexus.field.verified": "已验签",
  "settings.powersnexus.field.compatible": "兼容",
  "settings.powersnexus.field.keyID": "keyID",
  "settings.powersnexus.field.keyIDValue": "powersnexus-bundled-2026-01",
  "settings.powersnexus.field.lastChecked": "上次检查",
  "settings.powersnexus.field.lastError": "最近失败",
  "settings.powersnexus.field.deferred": "激活已延迟",
  "settings.powersnexus.action.check": "检查更新",
  "settings.powersnexus.action.rollback": "回滚到上一版本",
  "powersnexus.panel.title": "工作流",
  "powersnexus.panel.noChange": "尚未绑定 Change",
  "powersnexus.panel.empty": "当前会话没有可显示的 PowersNexus 工作流状态。创建 Change 或刷新后重试。",
  ...
  "powersnexus.action.createBind": "创建 Change 并绑定当前会话",
  "powersnexus.action.creating": "正在创建…",
  "powersnexus.panel.needSession": "请先打开一个会话，再创建并绑定工作流。",
  "powersnexus.toast.createOk": "工作流已绑定",
  "powersnexus.toast.createOkDesc": "已创建 Change 并绑定当前会话，面板将显示阶段与任务。",
  "powersnexus.error.noSession": "当前没有打开的会话，无法绑定工作流。",
  "powersnexus.error.create": "创建 PowersNexus Change 失败",
  "powersnexus.error.bind": "绑定会话到 Change 失败",
  ...
  "common.yes": "是",
  "common.no": "否",
  "settings.powersnexus.stableGate.title": "stable 生产门禁",
  "settings.powersnexus.stableGate.description": "启用生产 stable 前必须全部通过。默认 bundled 是安全策略。",
  "settings.powersnexus.stableGate.ready": "门禁结论",
  "settings.powersnexus.stableGate.readyYes": "可通过（仍需三平台 E2E）",
  "settings.powersnexus.stableGate.readyNo": "不可启用，保持 bundled",
  "settings.powersnexus.stableGate.unknown": "暂无门禁数据",
  "settings.powersnexus.stableGate.effective": "有效更新策略",
  "settings.powersnexus.stableGate.blockers": "阻塞项",
  "settings.powersnexus.stableGate.checks": "检查明细",
  "settings.powersnexus.stableGate.unavailable": "版本服务未返回 stableGate（可能未启用第一方模式）",

  "settings.powersnexus.isolation.title": "执行隔离",
  "settings.powersnexus.isolation.description": "正式自动批准前的执行边界。当前为逻辑权限模式，尚未启用 OS 级 Job Object/沙箱。",
  "settings.powersnexus.isolation.mode": "隔离模式",
  "settings.powersnexus.isolation.logical": "逻辑权限模式",
  "settings.powersnexus.isolation.os": "OS 级隔离（Windows Job Object）",
