...
export const dict = {
  ...
  "settings.agents.detail.prompt.source": "build、plan、general 等内置AI员工没有单独的 agent prompt。运行时会根据当前选择的模型加载基础系统提示词（例如 Codex、GPT、Claude、Gemini、Kimi 等模型各有对应基础提示词），再叠加任务上下文、技能说明和规则约束。因此这里不是空缺，而是“继承运行时基础提示词”。",
  ...
  "settings.projectInstruction.field.comment.placeholder": "可填写团队约定、技术偏好、需要重点关注的模块；留空则仅根据项目生成。",
