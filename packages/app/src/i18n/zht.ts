...
export const dict = {
  ...
  "dialog.provider.NovaWay.tagline": "可靠的優化模型",
  "dialog.provider.NovaWayGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "NovaWay 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 NovaWay 中使用 {{provider}} 模型。",
  ...
  "provider.connect.NovaWayZen.line1": "NovaWay Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.NovaWayZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.NovaWayZen.visit.prefix": "造訪 ",
  "provider.connect.NovaWayZen.visit.link": "NovaWay.ai/zen",
  "provider.connect.NovaWayZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 NovaWay 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 NovaWay 中使用 {{provider}} 模型。",
  ...
  "provider.custom.title": "自訂供應商",
  "provider.custom.description.prefix": "設定與 OpenAI 相容的供應商。請參閱",
  "provider.custom.description.link": "供應商設定文件",
  "provider.custom.description.suffix": "。",
  "provider.custom.field.provider.label": "選擇供應商",
  "provider.custom.field.provider.description": "選擇供應商後將自動填供應商 ID、名稱和基礎 URL",
  "provider.custom.field.provider.placeholder": "請選擇供應商",
  ...
  "provider.custom.field.name.placeholder": "我的 AI 供應商",
  ...
  "provider.custom.error.providerID.required": "供應商 ID 為必填",
  "provider.custom.error.providerID.format": "請使用小寫字母、數字、連字號或底線",
  "provider.custom.error.providerID.exists": "該供應商 ID 已存在",
  ...
  "dialog.plugins.empty": "在 NovaWay.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 NovaWay 伺服器。",
  ...
  "toast.update.description": "NovaWay 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 NovaWay 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (NovaWay.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: NovaWay 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "NovaWay 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 NovaWay 伺服器。",
  ...
  "settings.general.row.language.description": "變更 NovaWay 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 NovaWay 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 NovaWay 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 NovaWay 的主題。",
  ...
  "settings.updates.row.startup.description": "在 NovaWay 啟動時自動檢查更新",
