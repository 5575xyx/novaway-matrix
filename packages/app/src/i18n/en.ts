export const dict = {
  ...
  "settings.agents.config.description": "Edit the global `agent` object. Use this for custom agents, overrides, disables, and import/export.",
  ...
  "settings.agents.skills.note": "Skill categories are only used for browsing and organization. They do not limit which AI employee can use a skill.",
  "settings.agents.import.placeholder": "Enter any agent .md file or directory path, for example D:\\agents\\engineering\\frontend.md",
  ...
  "settings.agents.detail.prompt.empty": "This built-in agent does not define a separate prompt. It is driven by its mode, description, and built-in permission rules.",
  "settings.agents.detail.prompt.inherited": "This AI employee does not define a dedicated prompt. At runtime it inherits the base system prompt for the currently selected model.",
  "settings.agents.detail.prompt.source": "Built-in AI employees such as build, plan, and general do not have separate agent prompts. At runtime the app loads the base system prompt for the selected model, such as Codex, GPT, Claude, Gemini, or Kimi, then layers session context, skill instructions, and permission rules on top. This is inherited runtime content, not a missing prompt.",
  ...
  "settings.evolution.config.llm.description": "使用当前任务模型归纳技能、Agent、工作流和项目规则建议，会产生额外模型调用。",
  ...
  "settings.skills.description": "Manage built-in skills and custom skills from global and project .novaway directories.",
  ...
  "settings.skills.import.placeholder": "Enter any SKILL.md file or skill directory path, for example D:\\skills\\pricing\\SKILL.md",
  ...
  "settings.rules.description": "Manage Markdown system rules from the global rules directory and project .novaway/rules directory.",
  ...
  "settings.projectInstruction.description": "Manage the project-root AGENTS.md file, which future conversations load automatically.",
  ...
  "settings.projectInstruction.generating.description": "This can take a few dozen seconds. Keep this window open; project instructions refresh automatically when complete.",
  ...
  "settings.projectInstruction.generating.panel.idle": "After generation starts, this panel shows session creation, /init execution, and file writing.",
  ...
  "settings.projectInstruction.field.comment.placeholder": "Add team conventions, technical preferences, or key modules to inspect; leave empty to generate from the project only.",
  ...
  "settings.projectInstruction.toast.folderRequired.description": "Project instructions are written to AGENTS.md in the current project root.",
  "settings.projectInstruction.toast.started.title": "Project guide generation started",
  "settings.projectInstruction.toast.started.description": "A session was created and /init is running; open the session to track progress.",
  "settings.projectInstruction.toast.completed.title": "Project guide generated",
  "settings.projectInstruction.toast.completed.description": "AGENTS.md was updated and the project instruction list has refreshed.",
  ...
  "settings.plugins.config.description": "Edit the global `plugin` array. Entries can be package specs, file URLs, or tuples with options.",
