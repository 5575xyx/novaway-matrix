export const dict = {
  ...
  "settings.permissions.row.autoApprove.title": "Auto-approve permissions",
  "settings.permissions.row.autoApprove.description": "Automatically approve all permission requests (dangerous!)",
  ...
  "settings.powersnexus.title": "PowersNexus",
  "settings.powersnexus.description": "Inspect first-party PowersNexus version source, update policy, and rollback state.",
  "settings.powersnexus.active.title": "Active version",
  "settings.powersnexus.active.description": "Active bindings always pin the digest captured at bind time.",
  "settings.powersnexus.bundled.title": "Bundled baseline",
  "settings.powersnexus.previous.title": "Previous version",
  "settings.powersnexus.installed.title": "Installed versions",
  "settings.powersnexus.installed.empty": "No additional installed versions",
  "settings.powersnexus.field.policy": "Update policy",
  "settings.powersnexus.field.version": "Version",
  "settings.powersnexus.field.protocol": "Protocol",
  "settings.powersnexus.field.source": "Source",
  "settings.powersnexus.field.digest": "Digest",
  "settings.powersnexus.field.verified": "Verified",
  "settings.powersnexus.field.compatible": "Compatible",
  "settings.powersnexus.field.keyID": "keyID",
  "settings.powersnexus.field.keyIDValue": "powersnexus-bundled-2026-01",
  "settings.powersnexus.field.lastChecked": "Last checked",
  "settings.powersnexus.field.lastError": "Last error",
  "settings.powersnexus.field.deferred": "Activation deferred",
  "settings.powersnexus.action.check": "Check for updates",
  "settings.powersnexus.action.rollback": "Rollback to previous",
  "powersnexus.panel.title": "Workflow",
  "powersnexus.panel.noChange": "No change bound",
  "powersnexus.panel.empty": "No PowersNexus workflow snapshot for this session yet.",
  "powersnexus.field.revision": "Revision",
  "powersnexus.field.digest": "Digest",
  "powersnexus.field.profile": "Profile",
  "powersnexus.field.updatedAt": "更新时间",
  "powersnexus.field.nextAction": "主动作",
  "powersnexus.field.automatic": "自动",
  "powersnexus.section.blockers": "阻塞",
  "powersnexus.section.requirements": "需求",
  "powersnexus.section.tasks": "任务",
  "powersnexus.section.delivery": "交付与验证",
  "powersnexus.section.log": "步骤日志",
  "powersnexus.section.changes": "Change 列表",
  "powersnexus.action.archive": "Archive",
  "powersnexus.action.createBind": "Create Change & bind session",
  "powersnexus.action.creating": "Creating…",
  "powersnexus.panel.needSession": "Open a session first to bind the workflow.",
  "powersnexus.toast.createOk": "Workflow bound",
  "powersnexus.toast.createOkDesc": "Change created and bound to this session.",
  "powersnexus.error.noSession": "No open session to bind.",
  "powersnexus.error.create": "Failed to create PowersNexus Change",
  "powersnexus.error.bind": "Failed to bind session to Change",
  "powersnexus.toast.checkOk": "已检查更新",
  "powersnexus.toast.checkOkDesc": "版本状态已刷新；无可用端点时会保持 bundled。",
  "powersnexus.toast.rollbackOk": "已请求回滚",
  "powersnexus.toast.rollbackOkDesc": "活动版本已切换到 previous。",
  "powersnexus.toast.archiveOk": "归档完成",
  "powersnexus.toast.archiveOkDesc": "工作流已进入归档结果。",
  "powersnexus.error.version": "读取 PowersNexus 版本失败",
  "powersnexus.error.changes": "读取 Change 列表失败",
  "powersnexus.error.status": "读取工作流状态失败",
  "powersnexus.error.check": "检查更新失败",
  "powersnexus.error.rollback": "回滚失败",
  "powersnexus.error.archive": "归档失败",
  "powersnexus.error.noActive": "没有活动版本可回滚",
  "powersnexus.error.noSnapshot": "没有可归档的工作流快照",
  "common.yes": "Yes",
  "common.no": "No",
  "settings.powersnexus.stableGate.title": "Stable production gate",
  "settings.powersnexus.stableGate.description": "All required checks must pass before enabling production stable. Default bundled is the safe policy.",
  "settings.powersnexus.stableGate.ready": "Gate result",
  "settings.powersnexus.stableGate.readyYes": "Ready (still needs multi-OS E2E)",
  "settings.powersnexus.stableGate.readyNo": "Not ready - keep bundled",
  "settings.powersnexus.stableGate.unknown": "No gate data",
  "settings.powersnexus.stableGate.effective": "Effective update policy",
  "settings.powersnexus.stableGate.blockers": "Blockers",
  "settings.powersnexus.stableGate.checks": "Check details",
  "settings.powersnexus.stableGate.unavailable": "Version service did not return stableGate (first-party mode may be off)",

  "settings.powersnexus.isolation.title": "Execution isolation",
  "settings.powersnexus.isolation.description": "Execution boundary before full auto-approve. Currently logical permission mode.",
  "settings.powersnexus.isolation.mode": "Isolation mode",
  "settings.powersnexus.isolation.logical": "Logical permission mode",
  "settings.powersnexus.isolation.os": "OS isolation (Windows Job Object)",
