export const dict = {
  ...
  "dialog.provider.NovaWay.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.NovaWayGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NovaWay",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NovaWay.",
  ...
  "provider.connect.NovaWayZen.line1":
    "NovaWay Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.NovaWayZen.visit.prefix": "Odwiedź ",
  "provider.connect.NovaWayZen.visit.link": "NovaWay.ai/zen",
  "provider.connect.NovaWayZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NovaWay.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NovaWay.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w NovaWay.json",
  ...
  "dialog.server.description": "Przełącz serwer NovaWay, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja NovaWay ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NovaWay",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (NovaWay.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "NovaWay zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NovaWay",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd NovaWay na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NovaWay ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NovaWay.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NovaWay",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NovaWay.",
