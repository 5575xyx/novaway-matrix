export const dict = {
  ...
  "dialog.provider.group.free": "Accès gratuit",
  "dialog.provider.group.other": "Autre",
  "dialog.provider.tag.recommended": "Recommandé",
  "dialog.provider.NovaWay.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.NovaWay.tagline": "Modèles optimisés et fiables",
  "dialog.provider.NovaWayGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NovaWay",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NovaWay.",
  ...
  "provider.connect.NovaWayZen.line1":
    "NovaWay Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.NovaWayZen.visit.prefix": "Visitez ",
  "provider.connect.NovaWayZen.visit.link": "NovaWay.ai/zen",
  "provider.connect.NovaWayZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NovaWay.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NovaWay.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans NovaWay.json",
  ...
  "dialog.server.description": "Changez le serveur NovaWay auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'NovaWay ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NovaWay",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (NovaWay.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NovaWay ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "NovaWay inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NovaWay dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NovaWay",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NovaWay sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NovaWay suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NovaWay.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NovaWay",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NovaWay.",
