  ...
  const AdvancedSection = () => (
    <div class="flex flex-col gap-1">
      ...
      <SettingsList>
        ...
        <SettingsRow
          title={language.t("settings.permissions.row.autoApprove.title")}
          description={language.t("settings.permissions.row.autoApprove.description")}
        >
