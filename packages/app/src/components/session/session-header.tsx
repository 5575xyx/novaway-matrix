        ...
        {(mount) => (
          <Portal mount={mount()}>
            <Button
              ...
              variant="ghost"
              size="small"
              class="hidden h-8 w-[220px] max-w-full min-w-0 items-center gap-2 justify-between rounded-md border border-border-weak-base bg-surface-panel shadow-none cursor-default md:flex"
            ...
            <div class="flex flex-row items-center gap-1 shrink-0">
              <Show when={term()}>
                ...
                >
                  <Button
                    variant="ghost"
                    class="group/terminal-toggle titlebar-icon w-8 h-8 p-0 box-border rounded-xl text-icon-base hover:bg-surface-base-hover transition-all duration-150 hover:scale-105"
