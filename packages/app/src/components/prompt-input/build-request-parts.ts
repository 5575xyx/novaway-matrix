...
import { type AgentPartInput, type FilePartInput, type Part, type TextPartInput } from "@novaway/sdk/v2/client"
...
export function buildRequestParts(input: BuildRequestPartsInput) {
  const requestParts: PromptRequestPart[] = [
    ...(input.syntheticText?.trim()
      ? [
          {
            id: Identifier.ascending("part"),
            type: "text" as const,
            text: input.syntheticText.trim(),
            synthetic: true,
          },
        ]
      : []),
