                  ...
                  o =
                    ((a.prototype.run = function () {
                      for (var e = this.callStack[this.depth], t = e.error; 0 <= this.depth && e && !this.paused; )
                        if (
                          ...
                          ;(!e.construct ||
                            ("object" !== (n = r(this.rv)) && "function" !== n && (this.rv = e.scope.get(0))),
                    ...
                    (a.prototype.injectStackTrace = function (e) {
                      var t,
                        ...
                        l = 0
                      for (
                        this.depth > this.maxTraceDepth && (l = this.depth - this.maxTraceDepth),
                          n = r = a = this.depth,
                          s = l;
                        a <= s ? r <= s : s <= r;
                        n = a <= s ? ++r : --r
                    ...
                    (a.prototype.pushFrame = function (e, t, n, r, i, o, a) {
                      if ((null == o && (o = "<anonymous>"), null == a && (a = !1), this.checkCallStack()))
                        return (
                          (n = new d(n, e.localNames, e.localLength)),
                          n.set(0, t),
                    ...
                    (a.prototype.checkCallStack = function () {
                      return (
                        ...
                        ((this.callStack[this.depth].error = new Error("maximum call stack size exceeded")),
                        this.pause(),
                        !1)
                      )
                    }),
                ...
                var s =
                  ((c.prototype.run = function () {
                    for (
                      ...
                      this.ip !== this.exitIp && !this.paused && 0 !== this.fiber.timeout;

                    )
                      (this.fiber.timeout--, e[this.ip++].exec(this, this.evalStack, this.scope, this.realm))
              ...
              ;(function () {
                ...
                function u(e) {
                  ...
                  (this.get = function (e, t) {
                    if (null != e)
                      return a(e, t) || ("string" == typeof e && "number" == typeof t) || "length" === t
                        ? e[t]
                        : this.get(o(e), t)
                  }),
                ...
                var t = n(7),
                  ...
                  i = function (e) {
                    for (var n = [], r = 0; r < e.length; r++) {
                      for (
                        var i = e[r], o = t[i[0]], a = [], s = 1, c = 1, u = i.length;
                        1 <= u ? c < u : u < c;
                        s = 1 <= u ? ++c : --c
                      ) {
                        a.push(i[s])
                ...
                var t,
                  ...
                  f =
                    ((a = [
                      ...
                      new i("", function (e, t, n) {
                        if ((f(e, 0, "next", t.pop()), e.error instanceof o))
                      ...
                      new i("", function (e, t, n, r) {
                        var i = t.pop(),
                          o = t.pop()
                        return null == i
                          ? b(e, new Error("Cannot read property '" + o + "' of " + i))
                          : t.push(r.get(i, o))
                      }),
                      new i("", function (e, t, n, r) {
                        var i = t.pop(),
                          ...
                          a = t.pop()
                        return null == i
                          ? b(e, new Error("Cannot set property '" + o + "' of " + i))
                          : t.push(r.set(i, o, a))
                      }),
                      new i("", function (e, t, n, r) {
                        var i = t.pop(),
                      ...
                      new i("", function (e, t, n, r) {
                        ...
                        return s(r.global, o) || this.args[1]
                          ? t.push(r.global[o])
                          : b(e, new Error(o + " is not defined"))
                      }),
                      new i("", function (e, t, n, r) {
                      ...
                      new i("", function (e, t, n, r) {
                        return s(r.global, this.args[0]) || this.args[1]
                          ? t.push(r.global[this.args[0]])
                          : b(e, new Error(this.args[0] + " is not defined"))
                      }),
                      new i("", function (e, t, n, r) {
                    ...
                    function (e, t, n, r, i) {
                      ...
                      if (null == r)
                        return b(
                          e,
                          new Error("Cannot call method '" + n + "' of " + (void 0 === r ? "undefined" : "null")),
                        )
                      ...
                      return a instanceof Function
                        ? p(e, t, a, r, i)
                        : null == a
                          ? (o.pop(), b(e, new Error("Object #<" + s + "> has no method '" + n + "'")))
                          : (o.pop(), b(e, new Error("Property '" + n + "' of object #<" + s + "> is not a function")))
                    }),
