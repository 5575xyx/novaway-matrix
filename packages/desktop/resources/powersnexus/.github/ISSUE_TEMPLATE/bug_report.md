...
## Is this a PowersNexus issue or a platform issue?
<!-- PowersNexus is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without PowersNexus installed.

     If the problem persists without PowersNexus, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without PowersNexus installed
