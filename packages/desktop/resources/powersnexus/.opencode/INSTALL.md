...
another harness, install PowersNexus separately for each one.

## Migrating from the old symlink-based install

If you previously installed powersnexus using `git clone` and symlinks, remove the old setup:
...
# Remove skills.paths from opencode.json if you added one for powersnexus
```
...
OpenCode installs PowersNexus through a git-backed package spec. Some OpenCode
