...
```bash
cd /Users/drewritter/prime-rad/PowersNexus/tests/brainstorm-server
node auth.test.js
```
...
```bash
cd /Users/drewritter/prime-rad/PowersNexus
...
```bash
cd /Users/drewritter/prime-rad/PowersNexus
git check-ignore .PowersNexus/brainstorm/.last-token || true
```
...
```bash
cd /Users/drewritter/prime-rad/PowersNexus
git check-ignore .PowersNexus/brainstorm/.last-token
```

Expected output:

```text
.PowersNexus/brainstorm/.last-token
```
...
```bash
node /tmp/PowersNexus-pr1720-security-drewritter/probe-pr1720.cjs
```
