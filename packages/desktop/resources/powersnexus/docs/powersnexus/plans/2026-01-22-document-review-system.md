...
> **For agentic workers:** REQUIRED: Use PowersNexus:subagent-driven-development (if subagents available) or PowersNexus:executing-plans to implement this plan.
...
**Spec:** docs/PowersNexus/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/PowersNexus/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use PowersNexus:subagent-driven-development (if subagents available) or PowersNexus:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
