...
const TIPS: Tip[] = [
  ...
  "Create {highlight}novaway.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.novaway/commands/{/highlight} to define reusable custom prompts",
