...
import {
  EvolutionPaths,
  CandidateQuery as EvolutionCandidateQuery,
} from "../../src/server/routes/instance/httpapi/groups/evolution"
import {
  MemoryPaths,
  ListQuery as MemoryListQuery,
  ReviewCandidateQuery as MemoryReviewCandidateQuery,
...
const originalWorkspaces = Flag.NOVAWAY_EXPERIMENTAL_WORKSPACES
...
const openApiDriftRoutes = [
  ...
  { method: "get", path: EvolutionPaths.candidate, query: EvolutionCandidateQuery },
  { method: "get", path: MemoryPaths.list, query: MemoryListQuery },
  { method: "get", path: MemoryPaths.reviewCandidate, query: MemoryReviewCandidateQuery },
...
const numericSdkQueryParams = [
  ...
  { method: "get", path: EvolutionPaths.candidate, name: "limit", schema: { type: "number" } },
  { method: "get", path: MemoryPaths.list, name: "limit", schema: { type: "number" } },
  { method: "get", path: MemoryPaths.reviewCandidate, name: "limit", schema: { type: "number" } },
...
const booleanSdkQueryParams = [
  ...
  { method: "get", path: MemoryPaths.list, name: "includeArchived" },
...
afterEach(async () => {
  Flag.NOVAWAY_EXPERIMENTAL_WORKSPACES = originalWorkspaces
