...
Practical reference for the current tool-migration state in `packages/novaway`.
...
Tool tests should use the existing Effect helpers in `packages/novaway/test/lib/effect.ts`:
