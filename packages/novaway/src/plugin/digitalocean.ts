...
const MAK_NAME_PREFIX = "NovaWay-oauth"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>NovaWay - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to NovaWay."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              ...
              instructions:
                "Sign in to DigitalOcean in your browser. NovaWay will create a Model Access Key named NovaWay-oauth-* and load your Inference Routers. Re-run /connect to refresh routers later.",
