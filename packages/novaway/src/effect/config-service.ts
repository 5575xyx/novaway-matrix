 ...
 *   "@NovaWay/ServerAuthConfig",
 *   {
 *     password: Config.string("NovaWay_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NovaWay_SERVER_USERNAME").pipe(Config.withDefault("novaway")),
 *   },
 * ) {}
 *
