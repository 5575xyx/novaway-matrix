...
// HttpApiMiddleware in effect-smol cannot declare query params today 鈥?// remove this once upstream supports middleware-declared query schemas.
...
>()("@NovaWay/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@NovaWay/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.NOVAWAY_WORKSPACE_ID ? WorkspaceID.make(Flag.NOVAWAY_WORKSPACE_ID) : undefined
}
