...
//
// The saved variant persists across sessions in ~/.local/state/novaway/model.json
...
class Service extends Context.Service<Service, VariantService>()("@NovaWay/RunVariant") {}
