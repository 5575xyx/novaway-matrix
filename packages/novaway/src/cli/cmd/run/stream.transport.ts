...
import type { Event, GlobalEvent, OpencodeClient } from "@novaway/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@NovaWay/RunStreamTransport") {}
