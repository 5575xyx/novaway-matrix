...
import { OfficePptCommand } from "./cli/cmd/office-ppt"
...
import { CuratorCommand } from "./cli/cmd/curator"
...
import { ensureProcessMetadata } from "@novaway/core/util/opencode-process"
...
const cli = yargs(args)
  ...
  .middleware(async (opts) => {
    ...
    process.env.AGENT = "1"
    process.env.NOVAWAY = "1"
    process.env.NOVAWAY_PID = String(process.pid)

    Log.Default.info("novaway", {
