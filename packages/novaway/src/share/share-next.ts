import type * as SDK from "@novaway/sdk/v2"
...
const disabled = process.env["NOVAWAY_DISABLE_SHARE"] === "true" || process.env["NOVAWAY_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@NovaWay/ShareNext") {}
