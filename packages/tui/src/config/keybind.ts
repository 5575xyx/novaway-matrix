...
export const Definitions = {
  ...
  app_redraw: keybind("ctrl+l", "Redraw the screen"),
  ...
  workbench_open: keybind("<leader>p", "Open tool workbench"),
  workbench_back: keybind("q", "Return to tool workbench"),
  memory_review: keybind("<leader>M", "Open memory review dialog"),
  evolution_review: keybind("<leader>E", "Open evolution review dialog"),
...
export const CommandMap = {
  ...
  status_view: "NovaWay.status",
  debug_view: "NovaWay.debug",
  ...
  workbench_open: "workbench.open",
  workbench_back: "workbench.back",
