...
import defaultSoundPath from "@novaway/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@novaway/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@novaway/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@novaway/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@novaway/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@novaway/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "NovaWay"
const DEFAULT_PACK_ID = "NovaWay.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "NovaWay Default",
  builtin: true,
  sounds: {
