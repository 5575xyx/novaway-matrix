...
export const dict = {
  ...
  "ui.sessionTurn.diffs.thisTurn": "本次調整 {count} 個檔案",
  "ui.sessionTurn.diffs.session": "目前已調整 {count} 個檔案",
  "ui.sessionTurn.diffs.added": "新增 {count} 行",
  "ui.sessionTurn.diffs.deleted": "刪除 {count} 行",
  ...
  "dialog.usageExceeded.freeTier.description": "訂閱 NovaWay Go，可靠地使用最佳開源模型，每月 $5 起。",
  ...
  "ui.sessionTurn.status.thinking": "正在思考你的問題",
  "ui.sessionTurn.status.thinkingWithTopic": "正在思考你的問題：{{topic}}",
