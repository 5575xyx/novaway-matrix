...
export const dict = {
  ...
  "ui.sessionTurn.diffs.thisTurn": "本次调整 {count} 个文件",
  "ui.sessionTurn.diffs.session": "当前已调整 {count} 个文件",
  "ui.sessionTurn.diffs.added": "新增 {count} 行",
  "ui.sessionTurn.diffs.deleted": "删除 {count} 行",
  ...
  "dialog.usageExceeded.freeTier.description": "订阅 NovaWay Go，可靠地使用最佳开源模型，每月 $5 起。",
  ...
  "ui.sessionTurn.status.gatheringContext": "正在工作区搜索",
  "ui.sessionTurn.status.gatheredContext": "已搜索",
  ...
  "ui.sessionTurn.status.thinking": "正在思考你的问题",
  "ui.sessionTurn.status.thinkingWithTopic": "正在思考你的问题：{{topic}}",
  ...
  "ui.messagePart.compaction": "任务已压缩",
  "ui.messagePart.context.read.one": "{{count}} 次查找",
  "ui.messagePart.context.read.other": "{{count}} 次查找",
  ...
  "ui.message.forkMessage": "分叉到新任务",
  "ui.message.revertMessage": "重置到此点",
  "ui.message.copyResponse": "复制回复",
  "ui.message.copyImage": "复制图片",
  "ui.message.copyVideo": "复制视频",
  "ui.message.copied": "已复制！",
  "ui.message.download": "下载",
  ...
  "ui.tool.task": "任务",
  "ui.tool.skill": "技能",
  "ui.tool.generateImage": "生成图片",
  "ui.tool.generateVideo": "生成视频",
