...
import novawayThemeJson from "./themes/novaway.json"
...
const STORAGE_KEYS = {
  THEME_ID: "NovaWay-theme-id",
  COLOR_SCHEME: "NovaWay-color-scheme",
  THEME_CSS_LIGHT: "NovaWay-theme-css-light",
  THEME_CSS_DARK: "NovaWay-theme-css-dark",
} as const
...
const novawayTheme = novawayThemeJson as DesktopTheme
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  // Toggle .dark class for Tailwind dark mode variants
  if (isDark) {
...
export const { use: useTheme, provider: ThemeProvider } = createSimpleContext({
  ...
  init: (props: { defaultTheme?: string; onThemeApplied?: (theme: DesktopTheme, mode: "light" | "dark") => void }) => {
    const themeId = normalize(read(STORAGE_KEYS.THEME_ID) ?? props.defaultTheme) ?? "novaway"
    ...
    onMount(() => {
      ...
      const savedTheme = normalize(rawTheme ?? props.defaultTheme) ?? "novaway"
      ...
      if (!rawTheme) {
        write(STORAGE_KEYS.THEME_ID, "novaway")
        clear()
      }
