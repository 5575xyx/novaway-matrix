...
<Callout type="warn">
  Cross-engine transfer involves type mapping, defaults, constraints, and auto-increment differences. Validate
  transferred data afterward, and rehearse important migrations in a test environment first.
</Callout>
