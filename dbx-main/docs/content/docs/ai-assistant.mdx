...
<Callout type="warn">
  AI-generated SQL is not executed automatically. Review table names, columns, filters, and affected rows before running
  it, especially on production connections.
</Callout>
...
<Callout type="info">
  AI optimization suggestions are advisory. Confirm performance with the database execution plan, data volume, and index
  design.
</Callout>
