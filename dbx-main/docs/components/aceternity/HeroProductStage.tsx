...
export function HeroProductStage() {
  ...
  return (
    ...
    >
      ...
      <div
        className="landing-product-dots absolute right-[18px] bottom-4 z-[5] flex gap-[7px] items-center rounded-full p-1.5 max-[760px]:right-3 max-[760px]:bottom-[11px]"
        aria-label="DBX product screenshots"
      >
        {productSlides.map((slide, index) => (
          <button
