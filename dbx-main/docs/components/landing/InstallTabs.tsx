    ...
    >
      ...
      >
        ...
        <span className="grid gap-0.5 min-w-0">
          <strong className="overflow-hidden text-[15px] font-[780] leading-[1.2] truncate">
            {downloadLabel[lang]}
          </strong>
          <small className="overflow-hidden text-xs font-[520] leading-tight truncate text-[color-mix(in_srgb,#0f172a_48%,#94a3b8)]">
            {primary.label}
          </small>
        </span>
        <ChevronDown size={18} />
