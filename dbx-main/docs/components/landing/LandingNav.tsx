...
export function LandingNav({
  ...
  lang: "en" | "cn"
  active?: "home" | "databases" | "changelog" | "community" | "drivers"
}) {
    ...
    <nav ref={ref} className="landing-nav">
      <div className="flex items-center justify-between max-w-[1180px] h-16 mx-auto px-7 max-[760px]:min-h-[58px] max-[760px]:h-auto max-[760px]:px-[18px] max-[760px]:py-2.5">
        ...
        <div className="flex items-center gap-1">
          ...
          <Link
            href={`/${lang}/databases`}
            className={`landing-nav-link rounded-[7px] px-[11px] py-2 text-[13px] font-medium max-[760px]:hidden ${active === "databases" ? "text-landing-ink" : "text-landing-muted"}`}
          >
            {t.databases}
          </Link>
          <Link
