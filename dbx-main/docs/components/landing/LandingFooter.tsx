    ...
    <footer className="border-t border-[var(--color-landing-line)] bg-[#0b1120]">
      <div className="max-w-[1180px] mx-auto px-7 py-7 max-[760px]:px-[18px]">
        <div className="flex items-center justify-between gap-4 max-[760px]:flex-col max-[760px]:gap-3 max-[760px]:text-center">
          ...
          <Link
            href={`/${lang}`}
            className="flex items-center gap-2.5 text-[var(--color-landing-ink)] text-lg font-[820] shrink-0"
          >
          ...
          <div className="flex items-center gap-3 shrink-0">
            <a
              ...
              className="text-[var(--color-landing-muted)] hover:text-[var(--color-landing-ink)] transition-colors"
              aria-label="GitHub"
            >
              <GithubIcon />
            </a>
            <a
              href="https://cnb.cool/dbxio.com/dbx"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://atomgit.com/t8y2/dbx"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-40 hover:opacity-100 transition-opacity"
              aria-label="AtomGit"
