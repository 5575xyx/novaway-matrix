...
export default withEnglishFallback({
  ...
  sqlLibrary: {
    ...
    batchDeleteConfirm:
      "Tem certeza de que deseja excluir {count} itens selecionados? Esta ação não pode ser desfeita.",
  ...
  connection: {
    ...
    mysqlCleartextPasswordAuthHint:
      "Ative somente quando o servidor MySQL exigir o plugin de autenticação de senha em texto claro.",
    mysqlCaCertHint:
    ...
    zookeeperConnectStringHint:
      "Entradas host:porta separadas por vírgula ou linha. Deixe em branco para usar o host e porta acima.",
    ...
    nacosConsoleUrlHint:
      "Use o endereço do console/admin API do Nacos. O Nacos 3 Docker geralmente expõe o console em 8085; implantações antigas podem compartilhar 8848 com a porta de serviço.",
    ...
    sqlServerLegacyUnencryptedModeHint:
      "Aplica-se a transporte não criptografado ou criptografia apenas no login. Ainda falhará se o servidor exigir criptografia TLS 1.0.\nUse apenas em redes confiáveis, VPNs ou túneis SSH",
    ...
    agentJavaTooOld:
      "Este driver requer Java 21. Use o JRE 21 gerenciado pelo DBX ou selecione um executável Java 21 no Gerenciador de Drivers.",
    agentDriverUpdateConnectionHint:
      "Há uma atualização de driver integrada disponível para esta conexão. A falha de conexão pode estar relacionada a um driver local desatualizado. Atualize o driver correspondente no Gerenciador de Drivers e tente novamente.",
    ...
    mongoLegacyHint:
      "Use Legacy para servidores MongoDB antigos, especialmente versões anteriores à 4.2. Se a autenticação falhar e o usuário foi criado em admin, defina o BD de autenticação como admin.",
    mongoTlsAllowInvalidCertificates: "Desativar verificação de certificado TLS",
    mongoTlsAllowInvalidCertificatesHint:
      "Corresponde a tlsAllowInvalidCertificates=true e desativa toda a validação de certificados, não apenas a do hostname. Aumenta o risco de MITM. Geralmente é necessário para AWS DocumentDB via túnel SSH.",
    mongoRetryWrites: "Repetir gravações",
    mongoRetryWritesHint:
      "Corresponde a retryWrites. Desative para AWS DocumentDB, que não suporta gravações repetíveis.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMessage:
      "Algumas abas que você está fechando têm alterações não salvas que serão perdidas. Salvar antes de continuar?",
    unsavedChangesBatchCloseMultipleMessage:
      '{count} abas SQL que você está fechando têm alterações não salvas. O DBX está mostrando "{title}" no momento. Salvar antes de continuar?',
    unsavedChangesAppCloseMessage:
      '"{title}" tem alterações SQL não salvas que serão perdidas se você sair do DBX. Salvar antes de sair?',
    unsavedChangesAppCloseMultipleMessage:
      '{count} abas SQL têm alterações não salvas. O DBX está mostrando "{title}" no momento. Serão perdidas se você sair do DBX. Salvar antes de sair?',
  ...
  grid: {
    ...
    formattedJsonEditWarning:
      "Você está editando JSON formatado. Ao salvar, ele será gravado como JSON, então a formatação original pode mudar.",
  ...
  ai: {
    ...
    codexMcpRequiredDescription:
      "O Codex CLI usa o DBX MCP Server para acessar o schema do banco e as ferramentas de consulta. Instale-o antes de usar o Codex no assistente de AI.",
    ...
    codexCliPathEnvError:
      "Codex CLI Path deve conter apenas o caminho do executável. Adicione variáveis de ambiente abaixo.",
    codexCliEnv: "Variáveis de ambiente",
    codexCliEnvAdd: "Adicionar variável",
    codexCliEnvHint:
      "Variáveis opcionais passadas ao Codex CLI, como HTTPS_PROXY, NO_PROXY, SSL_CERT_FILE ou CODEX_CA_CERTIFICATE.",
    ...
    contextWindowHint:
      "Tokens. Deixe vazio para detecção automática. Defina manualmente para modelos locais/personalizados.",
  ...
  contextMenu: {
    ...
    confirmDropMongoAllIndexesMessage:
      'Tem certeza de que deseja remover todos os índices removíveis da coleção "{name}"?',
    confirmDropMongoAllIndexesDetails:
      'O MongoDB mantém o índice "_id_". Índices adicionais exigidos por shard key também podem permanecer; o resultado listará apenas os índices realmente removidos.',
    ...
    confirmDropBatchIndexesMessage:
      'Tem certeza de que deseja remover {count} índices selecionados de "{table}"? Esta ação não pode ser desfeita.',
    ...
    confirmDropCollectionMessage:
      'Tem certeza de que deseja remover a coleção "{name}"? Isso excluirá permanentemente a coleção e todos os seus documentos.',
  ...
  userAdmin: {
    ...
    unsupported:
      "Conexões compatíveis com MySQL e PostgreSQL são suportadas. SQL Server, Oracle e outros modelos de permissão podem ser adicionados em seguida.",
    ...
    privilegeHint:
      "Escolha privilégios, banco de dados e tabela, então visualize o SQL antes de aplicar. * significa global ou todas as tabelas.",
    database: "Banco de dados",
    schema: "Schema",
    table: "Tabela",
  ...
  structureEditor: {
    ...
    sqlServerIdentityTypeHint:
      "A identidade do SQL Server só aceita tinyint, smallint, int, bigint e decimal/numeric com escala 0",
  },
  diagram: {
  ...
  redis: {
    ...
    blockedCommand:
      "O comando {command} está bloqueado por segurança. Desative o ícone de escudo na barra de ferramentas para permiti-lo.",
    slowlog: "Slow Log",
  ...
  schemaDiff: {
    ...
    tableFilterHint:
      "Corresponde a nomes completos de tabela com regex. Não digite /.../. ^ significa começa com, $ significa termina com, | significa ou.",
    ...
    tableFilterHelpExample:
      "^user_ significa começa com user_; _bak$ significa termina com _bak; a|b significa a ou b.",
  ...
  settings: {
    ...
    sqlFormatterConfigErrorUnsupportedParams:
      "A substituição params não é compatível. A formatação SQL não substituirá marcadores.",
    ...
    quitOnCloseDescription:
      "Quando ativado, o botão de fechar encerra o DBX completamente em vez de minimizar para a bandeja.",
    closeActionPromptTitle: "Fechar janela",
    closeActionPromptDescription:
      "Escolha o que acontece ao clicar no botão de fechar. Você pode alterar depois em Configurações → Aparência.",
    ...
    updateDownloadSourceDescription:
      "Escolha de onde os instaladores de atualização no aplicativo são baixados. A fonte oficial é recomendada; CNB ou AtomGit podem ser mais rápidos em redes da China continental.",
    ...
    duckDbWorkerProcessIsolationDescription:
      "Executa consultas DuckDB em um processo worker separado. Se uma consulta longa não responder ao cancelamento, o DBX pode encerrar o processo worker para liberar o bloqueio do arquivo de banco de dados.",
    ...
    dataGridQuickEntryDescription:
      "Quando ativado, editar uma célula ou preencher a linha vazia inferior salva no banco de dados assim que o foco sai. Ajuda na entrada frequente, mas pode causar gravações acidentais.",
    ...
    tableColumnTemplateFieldsDescription:
      "Escolha um tipo de banco de dados e configure os tipos dos campos predefinidos usados ao criar novas tabelas.",
    ...
    openTabsRestoreModeHint:
      "As abas fixadas permanecem no lado esquerdo da barra de abas e funcionam bem como pontos de entrada frequentes.",
    ...
    sidebarTablePageSizeDescription:
      "Número máximo de tabelas/objetos carregados por página na árvore lateral. Aumente se tiver muitas tabelas para reduzir páginas.",
    ...
    syncWebDavDescription:
      "Envie ou restaure um snapshot do DBX, incluindo a biblioteca SQL salva, a partir de um serviço de armazenamento compatível com WebDAV.",
    ...
    syncAutoUploadDescription:
      "Executa enquanto o DBX está aberto. Downloads ainda exigem confirmação manual para evitar substituir SQL salvos localmente.",
    ...
    showExecutionTargetPickerDescription:
      "Quando ativado, executar sem seleção permite escolher entre a instrução atual e todo o SQL.",
    wordWrap: "Quebra de linha",
    ...
    sqlSemanticDiagnosticsEnabledDescription:
      "Quando ativado, o editor relata problemas semânticos como tabelas e colunas desconhecidas. Desative para reduzir a análise e verificações de metadados em SQL grande.",
    ...
    confirmUnsavedSqlCloseDescription:
      "Quando desativado, abas SQL com edições não salvas são fechadas ou o app é encerrado sem a caixa de diálogo de confirmação de salvamento.",
    autoAliasTables: "Adicionar alias de tabela automaticamente",
    autoAliasTablesDescription:
      "Ao escolher uma tabela em FROM ou JOIN, insere um alias gerado como order_items AS oi.",
    ...
    exportRowLimitEnabledDescription:
      "Quando ativado, as exportações de resultados de consulta e dados de tabela param no limite de linhas abaixo.",
    ...
    queryExportKeysetOptimizationEnabledDescription:
      "Aplica-se apenas a consultas de tabela única reconhecidas com segurança; consultas complexas recuam automaticamente.",
    ...
    mcpTraeConfigPath:
      "TRAE: Configurações > MCP > Adicionar > Adicionar manualmente; depois cole a configuração JSON.",
  ...
  driverStore: {
    ...
    offlineDownloadHint:
      "Para ambientes sem internet, baixe pacotes de driver offline em uma máquina com acesso à internet e importe-os aqui.",
    ...
    driverStoreDirDescription:
      "Configure locais separados para o plugin JDBC e dados de Agent/JRE. O app será reiniciado automaticamente após a migração.",
    ...
    driverStoreDirConfirm:
      "Alterar {target} migrará os dados relacionados para o novo local. Conexões relacionadas podem ser desconectadas durante a migração. O app será reiniciado automaticamente após. Continuar?",
