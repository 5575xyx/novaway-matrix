...
export default withEnglishFallback({
  ...
  sqlLibrary: {
    ...
    batchDeleteConfirm:
      "Sei sicuro di voler eliminare {count} elementi selezionati? Questa azione non può essere annullata.",
  ...
  connection: {
    ...
    mysqlCleartextPasswordAuthHint:
      "Attiva solo quando il server MySQL richiede il plugin di autenticazione password in chiaro.",
    mysqlCaCertHint:
    ...
    zookeeperConnectStringHint:
      "Voci host:porta separate da virgola o da riga. Lascia vuoto per usare l'host e la porta sopra.",
    ...
    nacosConsoleUrlHint:
      "Usa l'indirizzo console/admin API di Nacos. Nacos 3 Docker di solito espone la console su 8085; distribuzioni più vecchie possono condividere 8848 con la porta di servizio.",
    ...
    sqlServerLegacyUnencryptedModeHint:
      "Si applica al trasporto non crittografato o alla crittografia solo per il login. Fallirà comunque se il server richiede la crittografia TLS 1.0.\nUsala solo su reti attendibili, VPN o tunnel SSH",
    ...
    agentJavaTooOld:
      "Questo driver richiede Java 21. Usa il JRE 21 gestito da DBX o seleziona un eseguibile Java 21 in Gestione Driver.",
    agentDriverUpdateConnectionHint:
      "È disponibile un aggiornamento del driver integrato per questa connessione. Il problema di connessione potrebbe essere correlato a un driver locale obsoleto. Aggiorna il driver corrispondente in Gestione Driver e riprova.",
    ...
    mongoLegacyHint:
      "Usa Legacy per server MongoDB meno recenti, specialmente versioni precedenti alla 4.2. Se l'autenticazione fallisce e l'utente è stato creato in admin, imposta DB di Autenticazione su admin.",
    mongoTlsAllowInvalidCertificates: "Disabilita verifica certificato TLS",
    mongoTlsAllowInvalidCertificatesHint:
      "Corrisponde a tlsAllowInvalidCertificates=true e disabilita tutta la validazione del certificato, non solo il controllo dell'hostname. Aumenta il rischio MITM. Di solito è necessario per AWS DocumentDB tramite tunnel SSH.",
    mongoRetryWrites: "Riprova scritture",
    mongoRetryWritesHint:
      "Corrisponde a retryWrites. Disabilitalo per AWS DocumentDB, che non supporta scritture ripetibili.",
  ...
  editor: {
    ...
    unsavedChangesMessage:
      '"{title}" ha modifiche non salvate che andranno perse se chiudi. Salvare prima di chiudere?',
    unsavedChangesBatchCloseMessage:
      "Alcune schede che stai chiudendo hanno modifiche non salvate che andranno perse. Salvare prima di continuare?",
    unsavedChangesBatchCloseMultipleMessage:
      '{count} schede SQL che stai chiudendo hanno modifiche non salvate. DBX mostra attualmente "{title}". Salvare prima di continuare?',
    unsavedChangesAppCloseMessage:
      '"{title}" ha modifiche SQL non salvate che andranno perse se esci da DBX. Salvare prima di uscire?',
    unsavedChangesAppCloseMultipleMessage:
      '{count} schede SQL hanno modifiche non salvate. DBX mostra attualmente "{title}". Andranno perse se esci da DBX. Salvare prima di uscire?',
  ...
  grid: {
    ...
    formattedJsonEditWarning:
      "Stai modificando JSON formattato. Salvando verrà scritto come JSON, quindi la formattazione originale potrebbe cambiare.",
  ...
  ai: {
    ...
    contextWindowHint:
      "Token. Lascia vuoto per il rilevamento automatico. Imposta manualmente per modelli locali/personalizzati.",
    ...
    codexCliPathEnvError:
      "Codex CLI Path deve contenere solo il percorso dell'eseguibile. Aggiungi le variabili d'ambiente sotto.",
    codexCliEnv: "Variabili d'ambiente",
    codexCliEnvAdd: "Aggiungi variabile",
    codexCliEnvHint:
      "Variabili opzionali passate a Codex CLI, come HTTPS_PROXY, NO_PROXY, SSL_CERT_FILE o CODEX_CA_CERTIFICATE.",
    ...
    codexMcpRequiredDescription:
      "Codex CLI usa il DBX MCP Server per accedere allo schema del database e agli strumenti di query. Installalo prima di usare Codex nell'assistente AI.",
  ...
  contextMenu: {
    ...
    confirmDropMongoAllIndexesDetails:
      'MongoDB mantiene l\'indice "_id_". Altri indici richiesti dalla shard key potrebbero restare; il risultato elencherà solo quelli effettivamente eliminati.',
    ...
    confirmDropBatchIndexesMessage:
      'Sei sicuro di voler eliminare {count} indici selezionati da "{table}"? Questa azione non può essere annullata.',
    ...
    confirmDropCollectionMessage:
      'Sei sicuro di voler eliminare la collection "{name}"? Questa operazione eliminerà permanentemente la collection e tutti i suoi documenti.',
  ...
  userAdmin: {
    ...
    unsupported:
      "Connessioni compatibili con MySQL e PostgreSQL sono supportate. SQL Server, Oracle e altri modelli di autorizzazione possono essere aggiunti in seguito.",
  ...
  structureEditor: {
    ...
    sqlServerIdentityTypeHint:
      "Identity di SQL Server supporta solo tinyint, smallint, int, bigint e decimal/numeric con scala 0",
  },
  diagram: {
  ...
  redis: {
    ...
    blockedCommand:
      "Il comando {command} è bloccato per sicurezza. Disattiva l'icona scudo nella barra degli strumenti per consentirlo.",
    pubsub: "Pub/Sub",
  ...
  schemaDiff: {
    ...
    tableFilterHint:
      "Corrisponde ai nomi completi delle tabelle con regex. Non digitare /.../. ^ indica inizia con, $ indica finisce con, | indica o.",
  ...
  settings: {
    ...
    sqlFormatterConfigErrorUnsupportedParams:
      "La sostituzione params non è supportata. La formattazione SQL non sostituirà i segnaposto.",
    ...
    uiFontFamilyDescription:
      "Si applica a barra strumenti, schede, barra laterale, finestre di dialogo e altra UI fuori dall'editor.",
    ...
    quitOnCloseDescription:
      "Se attivato, il pulsante di chiusura termina completamente DBX invece di nasconderlo nella barra delle applicazioni.",
    closeActionPromptTitle: "Chiudi finestra",
    closeActionPromptDescription:
      "Scegli cosa succede quando clicchi il pulsante di chiusura. Puoi modificarlo in seguito in Impostazioni → Aspetto.",
    ...
    updateDownloadSourceDescription:
      "Scegli da dove scaricare gli installer degli aggiornamenti. La fonte ufficiale è consigliata; CNB o AtomGit possono essere più veloci sulle reti della Cina continentale.",
    ...
    duckDbWorkerProcessIsolationDescription:
      "Esegue le query DuckDB in un processo worker separato. Se una query lunga non risponde all'annullamento, DBX può arrestare il processo worker per rilasciare il blocco del file di database.",
    ...
    dataGridQuickEntryDescription:
      "Se attivo, la modifica di una cella o la compilazione della riga vuota in fondo viene salvata nel database appena il focus esce. Utile per inserimenti frequenti, ma può causare scritture accidentali.",
    infiniteScroll: "Caricamento a scorrimento infinito",
    infiniteScrollDescription:
      "Carica automaticamente la pagina successiva dei dati quando scorri fino in fondo alla tabella.",
    infiniteScrollMaxRows: "Righe max a scorrimento infinito",
    infiniteScrollMaxRowsDescription:
      "Numero massimo di righe da caricare in modalità scorrimento infinito (1000–50000).",
    tableColumnTemplateFields: "Campi predefiniti per nuove tabelle",
    tableColumnTemplateFieldsDescription:
      "Scegli un tipo di database e configura i tipi dei campi predefiniti usati durante la creazione di nuove tabelle.",
    ...
    openTabsRestoreModeHint:
      "Le schede fissate restano sul lato sinistro della barra delle schede e sono utili come punti di accesso frequenti.",
    ...
    sidebarTablePageSizeDescription:
      "Numero massimo di tabelle/oggetti caricati per pagina nell'albero laterale. Aumentalo se hai molte tabelle per ridurre le pagine.",
    ...
    syncWebDavDescription:
      "Carica o ripristina uno snapshot di DBX, inclusa la libreria SQL salvata, da un servizio di archiviazione compatibile con WebDAV.",
    ...
    syncAutoUploadDescription:
      "Viene eseguito mentre DBX è aperto. I download richiedono ancora conferma manuale per evitare di sostituire SQL salvati localmente.",
    ...
    showExecutionTargetPickerDescription:
      "Se attivo, l'esecuzione senza selezione permette di scegliere tra istruzione corrente e tutto l'SQL.",
    wordWrap: "A capo automatico",
    ...
    sqlSemanticDiagnosticsEnabledDescription:
      "Se abilitata, l'editor segnala problemi semantici come tabelle e colonne sconosciute. Disabilitala per ridurre l'analisi e i controlli dei metadati per file SQL di grandi dimensioni.",
    ...
    confirmUnsavedSqlCloseDescription:
      "Se disattivato, le schede SQL con modifiche non salvate verranno chiuse o usciranno senza la finestra di conferma di salvataggio.",
    autoAliasTables: "Aggiungi alias tabella automaticamente",
    autoAliasTablesDescription:
      "Quando scegli una tabella in FROM o JOIN, inserisce un alias generato come order_items AS oi.",
    ...
    exportRowLimitEnabledDescription:
      "Quando attivo, l'esportazione dei risultati di query e dei dati tabella si ferma al limite di righe sotto.",
    ...
    queryExportKeysetOptimizationEnabledDescription:
      "Si applica solo a query a tabella singola riconosciute in sicurezza; le query complesse ricadono automaticamente.",
    ...
    mcpTraeConfigPath:
      "TRAE: Impostazioni > MCP > Aggiungi > Aggiungi manualmente, poi incolla la configurazione JSON.",
    mcpVsCodeConfigPath:
      "VS Code/Copilot può usare .vscode/mcp.json nell'area di lavoro o mcp.json nel profilo utente.",
  ...
  driverStore: {
    ...
    offlineDownloadHint:
      "Per ambienti air-gapped, scarica i pacchetti driver offline su una macchina connessa a Internet, quindi importali qui.",
    ...
    driverStoreDirDescription:
      "Configura percorsi separati per il plugin JDBC e i dati Agent/JRE. L'app si riavvierà automaticamente dopo la migrazione.",
    ...
    driverStoreDirConfirm:
      "La modifica di {target} migrerà i dati correlati nella nuova posizione. Le connessioni correlate potrebbero essere disconnesse durante la migrazione. L'app si riavvierà automaticamente dopo. Continuare?",
