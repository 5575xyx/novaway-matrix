export default {
  ...
  connection: {
    ...
    mysqlCleartextPasswordAuthHint:
      "Enable only when the MySQL server requires the cleartext password authentication plugin.",
    ...
    zookeeperConnectStringHint:
      "Comma or line separated host:port entries. Leave blank to use the host and port above.",
    ...
    nacosConsoleUrlHint:
      "Use the Nacos console/admin API address. Nacos 3 Docker usually exposes the console on 8085; older deployments may share 8848 with the service port.",
    ...
    sqlServerLegacyUnencryptedModeHint:
      "Applies to unencrypted transport or login-only encryption. It will still fail if the server requires TLS 1.0 encryption.\nUse it only on trusted networks, VPNs, or SSH tunnels",
    ...
    agentJavaTooOld:
      "This driver requires Java 21. Use DBX managed JRE 21 or select a Java 21 executable in Driver Manager.",
    agentDriverUpdateConnectionHint:
      "A built-in driver update is available for this connection. The connection failure may be related to an outdated local driver. Update the corresponding driver in Driver Manager, then retry.",
    ...
    mongoLegacyHint:
      "Use Legacy for older MongoDB servers, especially versions below 4.2. If authentication fails and the user was created in admin, set Auth DB to admin.",
    mongoTlsAllowInvalidCertificates: "Disable TLS certificate verification",
    mongoTlsAllowInvalidCertificatesHint:
      "Maps to tlsAllowInvalidCertificates=true and disables all certificate validation, not just hostname checks. This increases MITM risk. Commonly required for AWS DocumentDB over an SSH tunnel.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMessage:
      "Some tabs you are closing have unsaved changes that will be lost. Save before continuing?",
    unsavedChangesBatchCloseMultipleMessage:
      '{count} SQL tabs you are closing have unsaved changes. DBX is currently showing "{title}". Save before continuing?',
    unsavedChangesAppCloseMessage:
      '"{title}" has unsaved SQL changes that will be lost if you quit DBX. Save before quitting?',
    unsavedChangesAppCloseMultipleMessage:
      '{count} SQL tabs have unsaved changes. DBX is currently showing "{title}". Save before quitting?',
  ...
  grid: {
    ...
    formattedJsonEditWarning:
      "You are editing formatted JSON. Saving will write it as JSON, so the original formatting may change.",
    setNull: "Set NULL",
  ...
  ai: {
    ...
    codexCliEnvHint:
      "Optional variables passed to Codex CLI, such as HTTPS_PROXY, NO_PROXY, SSL_CERT_FILE, or CODEX_CA_CERTIFICATE.",
    ...
    codexMcpRequiredDescription:
      "Codex CLI uses the DBX MCP Server to access database schema and query tools. Install it before using Codex in the AI assistant.",
  ...
  contextMenu: {
    ...
    confirmDropMongoAllIndexesDetails:
      'MongoDB keeps the "_id_" index. Additional shard-key-required indexes may also remain; the result will list only the indexes actually dropped.',
    ...
    confirmDropBatchIndexesMessage:
      'Are you sure you want to drop {count} selected indexes from "{table}"? This cannot be undone.',
    ...
    confirmDropCollectionMessage:
      'Are you sure you want to drop collection "{name}"? This will permanently delete the collection and all its documents.',
  ...
  structureEditor: {
    ...
    sqlServerIdentityTypeHint:
      "SQL Server identity only supports tinyint, smallint, int, bigint, and decimal/numeric with scale 0",
  },
  diagram: {
  ...
  schemaDiff: {
    ...
    tableFilterHint:
      "Matches full table names with regex. Do not type /.../. ^ means starts with, $ means ends with, | means or.",
  ...
  settings: {
    ...
    sqlFormatterConfigErrorUnsupportedParams:
      "The params replacement option is not supported. SQL formatting will not replace placeholders.",
    ...
    uiFontFamilyDescription:
      "Applies to app chrome such as the toolbar, tabs, sidebar, dialogs, and other non-editor UI.",
    ...
    quitOnCloseDescription:
      "When enabled, clicking the close button exits DBX completely instead of hiding it to the tray. You can change this later in Appearance settings.",
    closeActionPromptTitle: "Close window",
    closeActionPromptDescription:
      "Choose what happens when you click the close button. You can change this later in Settings > Appearance.",
    ...
    updateDownloadSourceDescription:
      "Choose where in-app update installers are downloaded from. The official source is recommended; CNB or AtomGit can be faster on mainland China networks.",
    ...
    duckDbWorkerProcessIsolationDescription:
      "Runs DuckDB queries in a separate worker process. If a long query does not respond to cancellation, DBX can stop the worker process to release the database file lock.",
    ...
    dataGridQuickEntryDescription:
      "When enabled, editing a cell or filling the bottom blank row saves to the database as soon as focus leaves. Useful for frequent entry, but it can cause accidental writes.",
    ...
    tableColumnTemplateFieldsDescription:
      "Choose a database type, then configure the preset field types used when creating new tables.",
    ...
    sidebarTablePageSizeDescription:
      "Maximum number of tables/objects loaded per page in the sidebar tree. Increase if you have many tables and want fewer pages.",
    ...
    syncWebDavDescription:
      "Upload or restore a DBX snapshot, including saved SQL library entries, from a WebDAV-compatible storage service.",
    ...
    syncSecretNotice:
      "By default, DBX syncs connection details and settings only. Database passwords, SSH passwords, proxy passwords, HTTP tunnel tokens, connection strings, and AI API keys stay local.",
    syncSecrets: "Sync encrypted secrets",
    syncSecretsDescription:
      "When enabled, DBX encrypts database passwords, SSH passwords, proxy passwords, HTTP tunnel tokens, and AI API keys before uploading them to WebDAV.",
    ...
    syncAutoUploadDescription:
      "Runs while DBX is open. Downloads still require manual confirmation to avoid replacing local saved SQL unexpectedly.",
    ...
    showExecutionTargetPickerDescription:
      "When enabled, running without a selection lets you choose between the current statement and all SQL.",
    wordWrap: "Word wrap",
    ...
    sqlSemanticDiagnosticsEnabledDescription:
      "When enabled, the editor reports semantic issues such as unknown tables and columns. Disable it to reduce parsing and metadata checks for large SQL.",
    ...
    confirmUnsavedSqlCloseDescription:
      "When disabled, SQL tabs with unsaved edits close or quit without the save confirmation dialog.",
    autoAliasTables: "Automatically add table aliases",
    autoAliasTablesDescription:
      "When selecting a table completion in FROM or JOIN, insert a generated alias such as order_items AS oi.",
    ...
    queryExportKeysetOptimizationEnabledDescription:
      "Only applies to safely recognized single-table queries; complex queries automatically fall back.",
  ...
  driverStore: {
    ...
    driverStoreDirDescription:
      "Set separate storage locations for the JDBC plugin and Agent/JRE data. The app will restart automatically after migration.",
    ...
    driverStoreDirConfirm:
      "Changing {target} will migrate the related driver data to the new location. Related driver connections may be disconnected during migration. The app will restart automatically after migration. Continue?",
