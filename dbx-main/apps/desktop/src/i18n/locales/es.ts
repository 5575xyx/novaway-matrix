...
export default withEnglishFallback({
  ...
  sqlLibrary: {
    ...
    batchDeleteConfirm:
      "¿Está seguro de que desea eliminar {count} elementos seleccionados? Esta acción no se puede deshacer.",
  ...
  connection: {
    ...
    sqliteExtensionsHint:
      'Una .dylib/.so/.dll por línea. Usa "ruta|punto de entrada" cuando se requiera un punto de entrada. Se cargan al conectar, luego load_extension se deshabilita.',
    ...
    mysqlCleartextPasswordAuthHint:
      "Actívala solo cuando el servidor MySQL requiera el plugin de autenticación de contraseña en claro.",
    ...
    zookeeperConnectStringHint:
      "Entradas host:puerto separadas por coma o por línea. Déjalo en blanco para usar el host y puerto de arriba.",
    ...
    nacosConsoleUrlHint:
      "Usa la dirección de consola/admin API de Nacos. Nacos 3 Docker normalmente expone la consola en 8085; despliegues antiguos pueden compartir 8848 con el puerto de servicio.",
    ...
    sqlServerLegacyUnencryptedModeHint:
      "Aplica a transporte sin cifrar o cifrado solo en el login. Seguirá fallando si el servidor requiere cifrado TLS 1.0.\nÚsalo solo en redes de confianza, VPN o túneles SSH",
    ...
    agentJavaTooOld:
      "Este controlador requiere Java 21. Use el JRE 21 administrado por DBX o seleccione un ejecutable Java 21 en el Administrador de controladores.",
    ...
    mongoLegacyHint:
      "Usa Legacy para servidores MongoDB antiguos, especialmente versiones anteriores a 4.2. Si falla la autenticación y el usuario se creó en admin, define Auth DB como admin.",
    mongoTlsAllowInvalidCertificates: "Desactivar verificación de certificado TLS",
    mongoTlsAllowInvalidCertificatesHint:
      "Se asigna a tlsAllowInvalidCertificates=true y desactiva toda la validación de certificados, no solo la del nombre de host. Aumenta el riesgo de MITM. Suele ser necesario para AWS DocumentDB a través de un túnel SSH.",
    mongoRetryWrites: "Reintentar escrituras",
    mongoRetryWritesHint:
      "Se asigna a retryWrites. Desactívalo para AWS DocumentDB, que no admite escrituras reintentables.",
  ...
  editor: {
    ...
    unsavedChangesMessage:
      '"{title}" tiene cambios sin guardar que se perderán si se cierra. ¿Guardar antes de cerrar?',
    unsavedChangesBatchCloseMessage:
      "Algunas pestañas que vas a cerrar tienen cambios sin guardar que se perderán. ¿Guardar antes de continuar?",
    unsavedChangesBatchCloseMultipleMessage:
      '{count} pestañas SQL que vas a cerrar tienen cambios sin guardar. DBX muestra actualmente "{title}". ¿Guardar antes de continuar?',
    unsavedChangesAppCloseMessage:
      '"{title}" tiene cambios SQL sin guardar que se perderán si sales de DBX. ¿Guardar antes de salir?',
    unsavedChangesAppCloseMultipleMessage:
      '{count} pestañas SQL tienen cambios sin guardar. DBX muestra actualmente "{title}". Se perderán si sales de DBX. ¿Guardar antes de salir?',
  ...
  grid: {
    ...
    formatterCustomTemplateHint:
      "Variables disponibles: ${value}, ${upper}, ${lower}, ${length}. Asígnale un nombre para guardarla en la lista.",
    ...
    formattedJsonEditWarning:
      "Estás editando JSON formateado. Al guardar se escribirá como JSON, por lo que el formato original puede cambiar.",
    ...
    queryEditReadyHint:
      'Este resultado de una sola tabla proviene de "{table}". Puedes editar, eliminar o agregar filas, luego usa la acción de cambios pendientes para guardar.',
    ...
    queryEditUnsupported: {
      ...
      "set-operation":
        "Los resultados de UNION, INTERSECT o EXCEPT no pueden asignarse de forma segura a las filas de origen.",
      aggregation: "Los resultados con DISTINCT, GROUP BY, HAVING y agregaciones no pueden editarse directamente.",
      "external-source":
        "Los archivos externos y los resultados de funciones de tabla no pueden escribirse directamente. Impórtalos a una tabla de base de datos antes de editarlos.",
      "complex-source":
        "JOINs, múltiples tablas y subconsultas no pueden asignarse de forma segura a una fila de origen.",
      "computed-columns":
        "Las expresiones calculadas o los resultados de funciones no pueden escribirse de vuelta. Selecciona nombres de columna originales.",
      "no-table": "No se detectó ninguna tabla de origen editable.",
      "no-primary-key":
        "La tabla de destino no tiene clave primaria, por lo que las filas no pueden actualizarse o eliminarse de forma segura.",
      "primary-key-not-returned":
        "Al resultado le falta la columna de clave primaria original. Inclúyela por su nombre de columna original.",
      "aliased-columns":
        "Las columnas de resultado usan alias o expresiones. Selecciona columnas editables por sus nombres originales.",
      "metadata-unavailable":
        "DBX no pudo cargar los metadatos de la tabla, por lo que la edición de resultados está deshabilitada.",
    },
  ...
  ai: {
    ...
    codexMcpRequiredDescription:
      "Codex CLI usa DBX MCP Server para acceder al esquema de la base de datos y a las herramientas de consulta. Instálalo antes de usar Codex en el asistente de IA.",
    codexCliPathEnvError:
      "Codex CLI Path debe contener solo la ruta del ejecutable. Agrega las variables de entorno abajo.",
    codexCliEnv: "Variables de entorno",
    codexCliEnvAdd: "Agregar variable",
    codexCliEnvHint:
      "Variables opcionales para Codex CLI, como HTTPS_PROXY, NO_PROXY, SSL_CERT_FILE o CODEX_CA_CERTIFICATE.",
    ...
    enableThinkingHint:
      "Esta opción solo tiene efecto en APIs /chat/completions y modelos compatibles. Cuando está desactivado, puede reducir significativamente el uso de tokens, pero la calidad de los resultados generados puede disminuir ligeramente.",
    ...
    contextWindowHint:
      "Tokens. Déjalo vacío para detección automática. Configúralo manualmente para modelos locales/personalizados.",
  ...
  contextMenu: {
    ...
    confirmDropMongoAllIndexesMessage:
      '¿Seguro que deseas eliminar todos los índices removibles de la colección "{name}"?',
    confirmDropMongoAllIndexesDetails:
      'MongoDB conserva el índice "_id_". También pueden mantenerse índices adicionales requeridos por shard keys; el resultado solo mostrará los índices realmente eliminados.',
    ...
    confirmDropBatchIndexesMessage:
      '¿Seguro que deseas eliminar {count} índices seleccionados de "{table}"? Esta acción no se puede deshacer.',
    ...
    confirmDropCollectionMessage:
      '¿Estás seguro de que deseas eliminar la colección "{name}"? Esto borrará permanentemente la colección y todos sus documentos.',
  ...
  userAdmin: {
    ...
    unsupported:
      "Se admiten conexiones compatibles con MySQL y PostgreSQL. Los modelos de permisos de SQL Server, Oracle y otros se pueden agregar próximamente.",
    ...
    privilegeHint:
      "Elige privilegios, base de datos y tabla, luego previsualiza el SQL antes de aplicar. * significa global o todas las tablas.",
    database: "Base de datos",
    schema: "Esquema",
    table: "Tabla",
  ...
  structureEditor: {
    ...
    sqlServerIdentityTypeHint:
      "La identidad de SQL Server solo admite tinyint, smallint, int, bigint y decimal/numeric con escala 0",
  },
  diagram: {
  ...
  redis: {
    ...
    blockedCommand:
      "El comando {command} está bloqueado por seguridad. Desactiva el icono de escudo en la barra de herramientas para permitirlo.",
    pubsub: "Pub/Sub",
  ...
  schemaDiff: {
    ...
    tableFilterHint:
      "Matches table names with JavaScript regex. Empty include means all tables; empty exclude means no exclusions.",
  ...
  settings: {
    ...
    sqlFormatterConfigErrorUnsupportedParams:
      "La sustitución params no es compatible. El formateo SQL no reemplazará marcadores.",
    ...
    uiFontFamilyDescription:
      "Se aplica a la barra superior, pestañas, barra lateral, diálogos y demás UI fuera del editor.",
    ...
    quitOnCloseDescription:
      "Si está activado, al pulsar el botón de cerrar DBX se cierra por completo en lugar de ocultarse en la bandeja.",
    closeActionPromptTitle: "Cerrar ventana",
    closeActionPromptDescription:
      "Elige qué ocurre al pulsar el botón de cerrar. Puedes cambiarlo después en Ajustes → Apariencia.",
    ...
    updateDownloadSourceDescription:
      "Elige de dónde se descargan los instaladores de actualización. Se recomienda la fuente oficial; CNB o AtomGit pueden ser más rápidos en redes de China continental.",
    ...
    duckDbWorkerProcessIsolationDescription:
      "Ejecuta las consultas de DuckDB en un proceso worker independiente. Si una consulta larga no responde a la cancelación, DBX puede detener el proceso worker para liberar el bloqueo del archivo de base de datos.",
    ...
    dataGridQuickEntryDescription:
      "Al activarlo, editar una celda o llenar la fila vacía inferior se guarda en la base de datos al perder el foco. Agiliza la captura frecuente, pero puede causar escrituras accidentales.",
    infiniteScroll: "Carga de desplazamiento infinito",
    infiniteScrollDescription:
      "Carga automáticamente la siguiente página de datos al desplazarse hasta el final de la tabla.",
    ...
    tableColumnTemplateFieldsDescription:
      "Elige un tipo de base de datos y configura los tipos de campo predefinidos usados al crear tablas nuevas.",
    ...
    openTabsRestoreModeHint:
      "Las pestañas fijadas permanecen en el lado izquierdo de la barra de pestañas y son útiles como puntos de entrada frecuentes.",
    ...
    sidebarTablePageSizeDescription:
      "Número máximo de tablas/objetos cargados por página en el árbol lateral. Auméntalo si tienes muchas tablas para reducir páginas.",
    ...
    syncWebDavDescription:
      "Sube o restaura una instantánea de DBX, incluida la biblioteca SQL guardada, desde almacenamiento compatible con WebDAV.",
    ...
    syncAutoUploadDescription:
      "Se ejecuta mientras DBX está abierto. Las descargas aún requieren confirmación manual para evitar reemplazar SQL guardado localmente.",
    ...
    showExecutionTargetPickerDescription:
      "Al activarlo, ejecutar sin selección permite elegir entre la sentencia actual y todo el SQL.",
    wordWrap: "Ajuste de línea",
    ...
    sqlSemanticDiagnosticsEnabledDescription:
      "Al activarse, el editor informa de problemas semánticos como tablas y columnas desconocidas. Desactívalo para reducir el análisis y las comprobaciones de metadatos en SQL grandes.",
    ...
    confirmUnsavedSqlCloseDescription:
      "Cuando se desactiva, las pestañas SQL con ediciones sin guardar se cierran o salen sin el diálogo de confirmación de guardado.",
    autoAliasTables: "Agregar alias de tabla automáticamente",
    autoAliasTablesDescription:
      "Al seleccionar una tabla en FROM o JOIN, inserta un alias generado como order_items AS oi.",
    ...
    exportRowLimitEnabledDescription:
      "Cuando está activado, las exportaciones de resultados de consultas y datos de tabla se detienen en el límite de filas indicado abajo.",
    ...
    queryExportKeysetOptimizationEnabledDescription:
      "Solo aplica a consultas de una sola tabla reconocidas de forma segura; las consultas complejas usan el método estándar automáticamente.",
    ...
    mcpVsCodeConfigPath:
      "VS Code/Copilot puede usar .vscode/mcp.json en el espacio de trabajo o mcp.json en el perfil de usuario.",
  ...
  driverStore: {
    ...
    offlineDownloadHint:
      "Para entornos sin conexión a internet, descarga los paquetes de drivers offline en una máquina con conexión, luego impórtalos aquí.",
    ...
    driverStoreDirDescription:
      "Configura ubicaciones separadas para el plugin JDBC y los datos de Agent/JRE. La aplicación se reiniciará automáticamente después de la migración.",
    ...
    driverStoreDirConfirm:
      "Cambiar {target} migrará los datos relacionados a la nueva ubicación. Las conexiones relacionadas pueden desconectarse durante la migración. La aplicación se reiniciará automáticamente después. ¿Continuar?",
