...
export async function mqCreateNamespace(
  connectionId: string,
  ns: NamespaceRef,
...
export async function mqCreateSubscription(
  connectionId: string,
  topic: TopicRef,
  sub: string,
  pos: ResetPosition,
...
export async function mqDeleteSubscription(
  connectionId: string,
  topic: TopicRef,
  sub: string,
  force: boolean,
...
export async function mqSkipMessages(
  connectionId: string,
  topic: TopicRef,
  sub: string,
  count: SkipCount,
...
export async function mqResetCursor(
  connectionId: string,
  topic: TopicRef,
  sub: string,
  pos: ResetPosition,
...
export async function mqPeekMessages(
  connectionId: string,
  topic: TopicRef,
  sub: string,
  count: number,
...
export async function mqExpireMessages(
  connectionId: string,
  topic: TopicRef,
  sub: string,
...
export async function mqSetRetention(
  connectionId: string,
  scope: PolicyScope,
...
// Permissions
export async function mqGrantPermission(
  connectionId: string,
  scope: PolicyScope,
  role: string,
  actions: AuthAction[],
