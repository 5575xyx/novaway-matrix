...
export function hasNativeClipboardSelection(
  env: NativeClipboardSelectionEnvironment = globalThis as unknown as NativeClipboardSelectionEnvironment,
): boolean {
...
export function eventTargetAllowsNativeClipboard(
