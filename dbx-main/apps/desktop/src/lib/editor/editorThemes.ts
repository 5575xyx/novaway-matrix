...
function createIdeEditorTheme(
  ...
  const highlightStyle = HighlightStyle.define([
    ...
    {
      tag: [tags.operator, tags.compareOperator, tags.logicOperator, tags.arithmeticOperator, tags.derefOperator],
      color: c.operator,
    },
    {
      tag: [tags.punctuation, tags.separator, tags.paren, tags.brace, tags.bracket, tags.angleBracket],
      color: c.punctuation,
    },
    { tag: tags.tagName, color: c.tag },
    { tag: tags.attributeName, color: c.attribute },
