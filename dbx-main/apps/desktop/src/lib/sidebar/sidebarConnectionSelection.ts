...
export function selectedConnectionDuplicateTargets(
  currentNode: TreeNode,
  selectedNodes: TreeNode[],
): ConnectionTreeNode[] {
  return selectedConnectionActionTargets(currentNode, selectedNodes)
...
export function selectedConnectionClipboardTargets(
  currentNode: TreeNode,
  selectedNodes: TreeNode[],
): ConnectionTreeNode[] {
  return selectedConnectionActionTargets(currentNode, selectedNodes)
...
export function selectedConnectionEditTarget(
  currentNode: TreeNode,
  selectedNodes: TreeNode[],
...
export function connectionPasteTargetGroupId(
