...
export function getDataGridConditionSuggestionPosition(
  inputRect: DataGridConditionSuggestionRect,
  options: DataGridConditionSuggestionPositionOptions,
): DataGridConditionSuggestionPosition {
