...
export function stepTemporalInputValue(
  value: string,
  kind: TemporalCellEditorKind,
  part: TemporalCellEditorPart,
  delta: number,
): string {
  ...
  const timeText = [timeParts.hour, timeParts.minute, timeParts.second]
