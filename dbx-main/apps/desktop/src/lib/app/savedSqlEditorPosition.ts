...
function normalizeSelection(
  selection: SavedSqlEditorSelection | undefined,
  docLength: number,
): SavedSqlEditorSelection {
  return {
...
export function createSavedSqlEditorPosition(input: {
  savedSqlId: string
  sql: string
  selection?: SavedSqlEditorSelection
  viewport?: SavedSqlEditorViewport
  now?: number
}): SavedSqlEditorPosition {
...
export function restoreSavedSqlEditorPosition(
  savedSqlId: string,
  sql: string,
): { selection?: SavedSqlEditorSelection; viewport?: SavedSqlEditorViewport } {
