...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    contentClass: "",
    triggerClass:
      "flex items-center gap-1 rounded-[6px] border px-2 py-0.5 text-[11px] text-muted-foreground hover:bg-muted hover:text-foreground",
...
<template>
  ...
  <Teleport to="body">
    <div
      v-if="open"
      ref="menuRef"
      class="fixed z-50 min-w-32 rounded-[6px] p-1 cn-menu-translucent text-popover-foreground"
      :class="contentClass"
      :style="menuStyle"
      role="menu"
    >
