...
} from "@/lib/dataGrid/dataGridTemporalEditor"
      ...
      <div v-if="hasDate" class="grid grid-cols-[4.5rem_4.5rem_4.5rem] gap-1.5">
        ...
        >
          <input
            ...
            @input="updateDateFromInput('year', $event)"
          />
        ...
        >
          <input
            ...
            inputmode="numeric"
            class="min-w-0 bg-transparent px-1 text-center text-[13px] tabular-nums outline-none"
            @input="updateDateFromInput('month', $event)"
          />
          <div class="grid border-l">
            <button
              type="button"
        ...
        >
          <input
            ...
            inputmode="numeric"
            class="min-w-0 bg-transparent px-1 text-center text-[13px] tabular-nums outline-none"
            @input="updateDateFromInput('day', $event)"
          />
          <div class="grid border-l">
            <button
              type="button"
      ...
      <div v-if="hasTime" class="grid grid-cols-[3.5rem_0.5rem_3.5rem_0.5rem_3.5rem] items-center gap-1.5">
        ...
        >
          <input
            ...
            inputmode="numeric"
            class="min-w-0 bg-transparent px-1 text-center text-[13px] tabular-nums outline-none"
            @input="updateTimeFromInput('hour', $event)"
          />
          <div class="grid border-l">
            <button
              type="button"
        ...
        >
          <input
            ...
            inputmode="numeric"
            class="min-w-0 bg-transparent px-1 text-center text-[13px] tabular-nums outline-none"
            @input="updateTimeFromInput('minute', $event)"
          />
          <div class="grid border-l">
            <button
              type="button"
        ...
        >
          <input
            ...
            inputmode="numeric"
            class="min-w-0 bg-transparent px-1 text-center text-[13px] tabular-nums outline-none"
            @input="updateTimeFromInput('second', $event)"
          />
          <div class="grid border-l">
            <button
              type="button"
