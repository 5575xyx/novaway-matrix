...
<template>
  <div
    ref="toolbarEl"
    class="app-toolbar h-10 flex items-center gap-1 px-2 border-b bg-muted/30 shrink-0 overflow-hidden"
  ...
  >
    ...
    <template v-if="!toolbarCollapsed">
      <Button
        v-if="toolbarItems.dataTransfer"
        variant="ghost"
        size="sm"
        :class="toolbarTextButtonClass"
      ...
      <Button
        v-if="toolbarItems.driverManager"
        variant="ghost"
        size="sm"
        :class="[toolbarTextButtonClass, { 'bg-accent': showDriverStore }]"
    ...
    <div ref="rightWrapper" class="flex items-center gap-1 overflow-hidden">
      ...
      <Tooltip v-if="toolbarItems.history">
        <TooltipTrigger as-child>
          <Button
            v-show="isRightItemVisible('history')"
            variant="ghost"
            size="icon"
            class="h-8 w-8 shrink-0"
      ...
      <Tooltip v-if="toolbarItems.theme">
        <TooltipTrigger as-child>
          <Button
            v-show="isRightItemVisible('theme')"
            variant="ghost"
            size="icon"
            class="h-8 w-8 shrink-0"
      ...
      <Tooltip v-if="toolbarItems.github">
        <TooltipTrigger as-child>
          <Button
            v-show="isRightItemVisible('github')"
            variant="ghost"
            size="icon"
            class="h-8 w-8 shrink-0"
    ...
    <Tooltip>
      <TooltipTrigger as-child>
        <Button
          ...
          size="icon"
          class="h-8 w-8 shrink-0"
          :class="{ 'bg-accent': showSettingsPage }"
