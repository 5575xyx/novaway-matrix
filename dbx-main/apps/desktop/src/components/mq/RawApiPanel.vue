...
const presets = computed<RawApiPreset[]>(() => {
  ...
  return [
    ...
    },
    {
      ...
      method: "GET",
      path:
        props.tenant && props.namespace && props.topic
          ? `/admin/v2/schemas/${pathSegment(props.tenant)}/${pathSegment(props.namespace)}/${pathSegment(props.topic.shortName)}/schema`
        ...
        <label>
          <span class="field-header">
            ...
            <button
              ...
              :disabled="isReadMethod || !bodyText.trim()"
          ...
          <textarea
            v-model="bodyText"
            class="json-body-textarea"
            :rows="bodyTextareaRows"
            placeholder='例如: {"key":"value"}'
            :disabled="isReadMethod"
          ></textarea>
        </label>
      </section>
