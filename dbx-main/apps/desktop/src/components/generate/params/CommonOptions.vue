  ...
  <div class="rounded-md border bg-muted/10 p-3 space-y-2">
    <div v-if="!disableDefault" class="flex items-center gap-2 text-xs">
      <input
        ...
        :checked="!!params.includeDefault"
        @change="params.includeDefault = !params.includeDefault"
      />
    ...
    <div v-if="!disableNull" class="flex items-center gap-2 text-xs">
      <input
        ...
        type="checkbox"
        class="h-3.5 w-3.5 accent-primary"
        :checked="!!params.includeNull"
        @change="params.includeNull = !params.includeNull"
      />
    ...
    <div v-if="!disableUnique" class="flex items-center gap-2 text-xs">
      <input
        ...
        type="checkbox"
        class="h-3.5 w-3.5 accent-primary"
        :checked="!!params.unique"
        @change="params.unique = !params.unique"
      />
    ...
    <div v-if="!disableLinks" class="flex items-center gap-2 text-xs">
      <input
        ...
        type="checkbox"
        class="h-3.5 w-3.5 accent-primary"
        :checked="!!params.disableLinks"
        @change="params.disableLinks = !params.disableLinks"
      />
