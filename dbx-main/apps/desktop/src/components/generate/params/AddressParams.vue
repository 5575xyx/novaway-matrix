...
const cnStreets = [
  "No. 88, YuShuang Road",
  "No. 128, Nanjing West Road",
  "No. 56, RenMin Avenue",
  "No. 201, ZhongShan Road",
  "No. 77, ChangJiang Road",
]
    ...
    <div class="rounded-md border bg-muted/10 p-3">
      ...
      <div class="flex items-center gap-2 text-xs">
        <button
          ...
          :class="
            (params.addressType || 'line1') === t.value
              ? 'bg-primary text-primary-foreground border-primary'
              : 'bg-background'
          "
          @click="params.addressType = t.value"
        >
          {{ t.label }}
        </button>
      </div>
    ...
    <div class="rounded-md border bg-muted/10 p-3">
      ...
      <div class="flex flex-wrap gap-1.5">
        <button
          ...
          class="px-2 py-1 rounded border text-xs"
          :class="
            (params.regions ?? []).includes(r.value)
              ? 'bg-primary text-primary-foreground border-primary'
              : 'bg-background'
          "
