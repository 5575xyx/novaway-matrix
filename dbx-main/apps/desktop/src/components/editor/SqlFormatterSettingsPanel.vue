  ...
  <div class="flex flex-col gap-4">
    ...
    <Tabs v-model="activeMode" class="min-h-0">
      ...
      <TabsContent value="json" class="m-0 flex min-h-0 flex-col gap-3 pt-2">
        ...
        <p
          v-if="jsonEditorLoadError"
          class="rounded-md border border-amber-300/60 bg-amber-50 px-3 py-2 text-xs text-amber-800 dark:border-amber-400/40 dark:bg-amber-950/30 dark:text-amber-200"
        >
