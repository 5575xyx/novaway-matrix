        ...
        <div v-if="hasResults" class="space-y-3">
          ...
          <div v-else-if="syncPlan.syncSql.trim()" class="space-y-1">
            ...
            <textarea
              ...
              readonly
              class="w-full h-48 rounded-[6px] border bg-muted/20 p-3 font-mono text-xs resize-none focus:outline-none focus:ring-1 focus:ring-ring"
            />
          </div>
