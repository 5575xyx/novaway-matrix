...
import {
  ...
  queryTimeoutSecsForConnection,
} from "../../apps/desktop/src/lib/sql/queryTimeout.ts"
...
test("frontend query timeout scales with SQL statement count", () => {
  ...
  assert.equal(
    frontendQueryTimeoutSecsForSql("INSERT INTO users VALUES (1); INSERT INTO users VALUES (2);", "mysql", 30),
    120,
  )
  assert.equal(
    frontendQueryTimeoutSecsForSql(
      "INSERT INTO users VALUES (1); INSERT INTO users VALUES (2); INSERT INTO users VALUES (3);",
      "mysql",
      10,
    ),
    180,
  ...
  assert.equal(
    frontendQueryTimeoutSecsForSql("INSERT INTO users VALUES (1); INSERT INTO users VALUES (2);", "mysql", 0),
    0,
  )
})
