...
test("eventTargetAllowsAppClipboardShortcut ignores editable targets only", () => {
  ...
  assert.equal(
    eventTargetAllowsAppClipboardShortcut({ key: "v", ctrlKey: true, shiftKey: true, target: buttonTarget }),
    false,
  )
